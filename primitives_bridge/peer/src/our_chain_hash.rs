...
fixed_hash::construct_fixed_hash! {
	/// Hash type used in Peer chain.
	#[derive(MallocSizeOf, TypeInfo)]
	pub struct PeerHash(64);
}

#[cfg(feature = "std")]
impl_serde::impl_fixed_hash_serde!(PeerHash, 64);

impl_codec::impl_fixed_hash_codec!(PeerHash, 64);

impl CheckEqual for PeerHash {
	#[cfg(feature = "std")]
