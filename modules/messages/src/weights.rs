...
impl<T: frame_system::Config> WeightInfo for MillauWeight<T> {
	...
	fn send_16_kb_message_worst_case() -> Weight {
		Weight::from_parts(149_149_000, 0)
			.saturating_add(T::DbWeight::get().reads(7_u64))
			.saturating_add(T::DbWeight::get().writes(12_u64))
	}
	fn maximal_increase_message_fee() -> Weight {
		Weight::from_parts(6_015_058_000, 0)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn increase_message_fee(i: u32) -> Weight {
		Weight::from_parts(0, 0)
			//.saturating_add((2_000 as Weight).saturating_mul(i_u64))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn receive_single_message_proof() -> Weight {
		Weight::from_parts(179_892_000, 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn receive_two_messages_proof() -> Weight {
		Weight::from_parts(291_793_000, 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn receive_single_message_proof_with_outbound_lane_state() -> Weight {
		Weight::from_parts(192_191_000, 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn receive_single_message_proof_1_kb() -> Weight {
		Weight::from_parts(202_104_000 , 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn receive_single_message_proof_16_kb() -> Weight {
		Weight::from_parts(357_144_000, 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn receive_single_prepaid_message_proof() -> Weight {
		Weight::from_parts(122_648_000 , 0)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	fn receive_delivery_proof_for_single_message() -> Weight {
		Weight::from_parts(107_631_000, 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	fn receive_delivery_proof_for_two_messages_by_single_relayer() -> Weight {
	...
	fn receive_delivery_proof_for_two_messages_by_two_relayers() -> Weight {
		Weight::from_parts(155_151_000 , 0)
