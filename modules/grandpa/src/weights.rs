...
impl<T: frame_system::Config> WeightInfo for MillauWeight<T> {
	fn submit_finality_proof(p: u32, v: u32) -> Weight {
		Weight::from_parts(115_651_000, 0)
		.saturating_add(Weight::from_parts(61_465_000, 0).saturating_mul(p.into()))
		.saturating_add(Weight::from_parts(3_438_000, 0).saturating_mul(v.into()))
